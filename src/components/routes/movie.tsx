    ...
    return (
      <Tile context="is-ancestor">
        <Tile horizontalSize="is-4" isVertical context="is-parent">
          { this.state.t1.map((movie) => <TileMovie key={movie.id} movie={movie} />) }
        </Tile>
        <Tile horizontalSize="is-4" isVertical context="is-parent">
          { this.state.t2.map((movie) => <TileMovie key={movie.id} movie={movie} />) }
        </Tile>
        <Tile horizontalSize="is-4" isVertical context="is-parent">
          { this.state.t3.map((movie) => <TileMovie key={movie.id} movie={movie} />) }
        </Tile>
      </Tile>
    );
  }
